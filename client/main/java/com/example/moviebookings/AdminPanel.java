   ...
   @FXML
    public void addVoter(ActionEvent event){
       ...
       if(!client.sendData("14.!")){
           ...
           Person newPerson = new Person(name.getText(), dateOfBirth.getValue().toString(), sex.getText(), phoneNumber.getText(), voterID.getText());
           ...
           String data = "5.!" + id + ".!" + name1 + ".!" + dob + ".!" + gender + ".!" + ph;
    ...
    public void gotomanagevoter(MouseEvent mouseEvent) throws IOException {
